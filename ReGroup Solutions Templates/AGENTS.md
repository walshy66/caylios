# ReGroup Solutions Templates AGENTS.md
...
Owns template folders under `ReGroup Solutions Templates/`.
...
Keep templates organized by scenario and clearly distinguish examples from implementation contracts.
